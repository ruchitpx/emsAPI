...
Overview: This assignment focuses on building an Event Management API using Django and Django REST Framework (DRF). The API will allow users to create events, RSVP, and leave reviews. This assignment tests your understanding of key DRF and Django concepts like serializers, viewsets, permissions, and authentication.
Objective: Demonstrate your ability to build RESTful APIs using Django REST Framework, manage relationships between models, and implement authentication, permissions, and validations.
...
Submission Guidelines
	Fork the provided repository and complete the assignment.
	Commit your changes regularly with clear commit messages.
	Add a README.md file with setup instructions.
	Submit the GitHub repository link once you’ve completed the project.
